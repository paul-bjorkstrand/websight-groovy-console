...
Groovy Console modules provides full Groovy Console functionality. 
Gives possibility to develop Groovy scripts, to automate repetitive tasks. 
Create, test and promote without mistakes.
